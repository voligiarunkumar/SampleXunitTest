...
namespace Restaurant.Web.Areas.Manage.Controllers
{
    [Area("Manage")]
    public class MenuItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MenuItemId,MenuItemName,Description,IsEnabled,CategoryId")] MenuItem menuItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MenuItemId,MenuItemName,Description,IsEnabled,CategoryId")] MenuItem menuItem)
        {
